...
<head>
    ...
    <script type="text/javascript">
        ...
        /*$report->loadFile('http://tms.itnusantara.online:8080/web.tms/public/reports/SimpleList1.mrt');*/
		
		$report->loadFile('public/reports/SimpleList1.mrt');
		/** var dataSet = new Stimulsoft.System.Data.DataSet("Demo");
        dataSet.readJsonFile();
