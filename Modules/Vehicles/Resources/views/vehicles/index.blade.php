    ...
    $(document).ready(function() {
        setTimeout(function() {
            ...
            $('button#refresh').on('click', function() {
                if ($('table#vehicle_datatable').DataTable().settings()[0]['oInit'].serverSide == true) {
                    $('table#vehicle_datatable').DataTable().draw();
                } else {
                    window.location.reload();
                }
            });

            $('table#vehicle_datatable').on('click', 'button#btn_update', function() {
                let data = $(this).data()
                let id = data.id
                $.ajax({
                    headers: {
            ...
            $('table#vehicle_datatable').on('click', 'button#btn_delete', function() {
                let data = $(this).data()
                let id = data.id
